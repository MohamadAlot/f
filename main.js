...
function inputt() {
  ...
  } else if (input.toLowerCase() == "is mohamad a good person ?") {
    outputEl.innerHTML = "he is the best!!";
  } else if (input.toLowerCase() == "is mohamad hot?") {
    outputEl.innerHTML = "of course he is are you blind!!";
